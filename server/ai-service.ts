...
JSON structure:
{
  ...
  "summary": "VALUE DRIVERS NARRATIVE (McKinsey clarity, Hemingway brevity):\n\nSTRUCTURE:\n- Lead with the number that matters most. Make it big. Make it alone on its own line.\n- One paragraph, one job. If a paragraph does two things, split it.\n- Warnings and risks stand alone. Never bury them. Use ⚠️ marker and bold headers. Executives skim—critical risks must survive a skim.\n\nCONTENT (5 paragraphs max):\n1. THE BIG NUMBER: Total annualized value on its own line. Bold. Then one sentence stating use case count and Critical-priority count.\n2. TOP OPPORTUNITIES: Name the top 3 with dollar values. One sentence each. No compound sentences.\n3. STRATEGIC FOCUS: Operational vs customer-facing breakdown. Percentage by driver. Two sentences max.\n4. ⚠️ CRITICAL RISK: Standalone paragraph. Identify highest-value/highest-complexity use case, its share of total value, effort score, timeline. State consequence of failure in plain language.\n5. TOKEN ECONOMICS: One sentence on which use cases favor efficiency over volume. Translate jargon into consequence (e.g., 'high-frequency operations burn costs faster than they return value').\n\nSTYLE:\n- Write like Hemingway edited a McKinsey deck. Short sentences. Active voice.\n- No throat-clearing ('It is important to note that...'). Delete 'leverage,' 'utilize,' 'in order to.'\n- Numbers need white space. Don't stack them in prose. Use line breaks or bold callouts.\n- Vary sentence length. Short. Then slightly longer to carry detail. Then short again to land it.\n- End with implication, not summary. Tell them what it means, not what you said.\n- Assume 30 seconds of attention. Lead with 'so what,' follow with 'how we know.'",
  "executiveDashboard": {
