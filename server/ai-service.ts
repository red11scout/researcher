...
{
  "steps": [
    {"step": 0, "title": "Company Overview", "content": "Write flowing narrative paragraphs. NO markdown, NO asterisks, NO pipes, NO headers, NO tables, NO special formatting. Paragraphs: (1) Company profile with name, headquarters, estimated revenue, and business description in natural sentences. (2) Scale paragraph describing employees, customers, market presence. (3) Key business challenges - each challenge gets its own paragraph starting with the dollar impact in the first sentence (e.g., 'The company faces a $75M annual challenge in implementation labor costs.'), followed by 2-3 sentences explaining the problem. Final paragraph: 'Sourcing note:' followed by comma-separated list of assumptions and data sources.", "data": null},
  ...
  "summary": "PROFESSIONAL NARRATIVE PROSE in Amazon 6-pager style. NO markdown syntax, NO asterisks, NO pipes, NO hash symbols, NO tables, NO special characters, NO emoji. Write as flowing paragraphs.\n\nSTRUCTURE (each as a separate paragraph):\n\n1. HEADLINE PARAGRAPH: Start with the total annual value as a plain number (e.g., 'This assessment identifies $148.1M in annual value across 10 use cases, with 2 designated as Critical-priority for Q1 implementation.')\n\n2. VALUE COMPOSITION PARAGRAPH: Describe the breakdown in prose: 'Cost reduction opportunities account for $99.3M (67% of total value), followed by cash flow improvements at $18.9M (13%), revenue growth at $15.9M (11%), and risk mitigation at $14.0M (9%). The portfolio tilts 67% toward operational efficiency versus 33% toward revenue and risk initiatives, with back-office functions dominating customer-facing opportunities by 4:1.'\n\n3. TOP OPPORTUNITIES PARAGRAPHS: One paragraph per use case (maximum 4). Start each with the use case name and value, then describe what it does and why it matters. Example: 'The AI-Assisted Client Data Integration Mapping initiative represents a $31.2M opportunity. This solution automates schema mapping across five vertical platforms, eliminating 1,200 manual hours per deployment cycle.'\n\n4. PORTFOLIO RISK PARAGRAPH: Describe the concentration risk in prose. 'The portfolio carries concentration risk in UC-01 (AI-Assisted Client Data Integration Mapping), which accounts for 21% of total value. Implementation requires 15 months with dependencies on data schema standardization and platform API integration. Failure to execute would expose $31.2M in value and compress services margins on fixed-price contracts. Mitigation requires phased vertical-by-vertical rollout with a 20-deployment pilot before full-scale implementation.'\n\n5. TOKEN ECONOMICS PARAGRAPH: Describe the economics in prose. 'Token economics favor high-complexity, low-frequency workflows. Integration Mapping generates $945 return per dollar of token cost, while Support Knowledge returns $394 per dollar. Total investment across all use cases is $204K annually against $148M in returns.'\n\nCRITICAL RULES:\n- NO asterisks ** for bold\n- NO pipe | characters\n- NO hash # symbols\n- NO horizontal rules ---\n- NO arrow symbols\n- NO emoji\n- NO brackets for confidence levels\n- Write ONLY plain prose paragraphs\n- Use natural sentence structure\n- Numbers should appear inline in sentences",
  "executiveDashboard": {
